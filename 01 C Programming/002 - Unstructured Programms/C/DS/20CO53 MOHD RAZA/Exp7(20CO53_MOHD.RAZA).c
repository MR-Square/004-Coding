/*				Exp No.07.Implementation of Singly Linked List (SLL)
...
is made up of two items: the data and a reference (or pointer), which points to the
next node. A linked list is a collection of nodes where each node is connected to
...
/*
Conclution:
.			I understood that how to implement the concept of linked list and put
